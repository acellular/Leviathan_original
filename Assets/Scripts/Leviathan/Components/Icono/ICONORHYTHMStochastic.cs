//STOCHASTIC ICONORHYTHM
public class ICONORHYTHMStochastic : ICONORHYTHM
{
    ...
    public override void Response()
    {
        ...
        else if (rnd.NextDouble() < discomfort * discomfort * discomfort * threshProb)
        {
            ...
            //NEW
            //consumption.outsideChangeOUT += 20;
        }

        //at a much lower rate than looking for other paradigms to copy, MUTATE a new paradigm,
        //however, mutation happens according to the paradigm's own mutation rules
        if (!counterPicked && rnd.NextDouble() < discomfort * discomfort * discomfort * (threshProb * leviathan.paradigm.mutationRate))
        {
            ...
            newPara = true;
            //NEW
            //consumption.outsideChangeOUT += 60;
        }
